...
DefaultDirName={userappdata}\obs-studio\plugins\{#PluginDirName}
...
[Messages]
WelcomeLabel2=Aquest instal·lador copiarà el plugin REC Time Monitor a la carpeta de plugins d'OBS Studio (%APPDATA%\obs-studio\plugins\{#PluginDirName}). Tanca OBS Studio abans de continuar.
